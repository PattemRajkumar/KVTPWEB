<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KVTPHeader.ascx.cs" Inherits="Navigations_KVTPHeader" %>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="margin-top: -20px;">
                  ...
                  <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../MasterDepartment.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Master Department</p>
                                </a>
                            </li>
                             <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../MasterDesignations.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Master Designation</p>
                                </a>
                            </li>
                             <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../KVTP_Master_Employee.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Employee Registation</p>
                                </a>
                            </li>
                             <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../StudentRegister.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Student Registation</p>
                                </a>
                            </li>
                            
                             <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../MasterSem.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Master Semister</p>
                                </a>
                            </li>
                              <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../MasterSubject.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700">Master Subject</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                  ...
                  <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item" style="border-bottom: 1px solid #ddd">
                                <a href="../Configuration.aspx" class="nav-link">
                                    <i class="fa fa-cube nav-icon" style="color: #fff !important; font-size: 12px;margin-right:15px;"></i>
                                    <p style="color: #fff !important; font-size: 12px !important; font-weight: 700"> Configuration</p>
                                </a>
                            </li>
                        </ul>
                    </li>
